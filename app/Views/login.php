      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <img src="<?= base_url('template') ?> /assets/img/1.png" alt="logo" width="90" class="shadow-light rounded-circle">
            </div>
        ...
        <?php endif; ?>
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="<?= base_url('user/register') ?>">Crete One</a>
            </div>
